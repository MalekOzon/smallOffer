...
(()=>{
    const e = new Error("Cannot find module '../../../../public/resourses/userAvatar.svg'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
(()=>{
    const e = new Error("Cannot find module '../../../../public/resourses/placeholderPost.svg'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
...
const PublicStore = ()=>{
    ...
    const { data, error: postError, isLoading: isFetchingPosts } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$postServices$2f$postQueries$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGetPostPublicPage"])(username, page, pageSize);
...
_s(PublicStore, "uPhVVAmrZvIfRoZltrud1ChS1oY=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useParams"],
        __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$postServices$2f$postQueries$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGetPostPublicPage"]
    ];
});
_c1 = PublicStore;
...
const PublicStore = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PublicStore.useEffect": ()=>{
            if (!data || !userData || !Array.isArray(data.results)) return;
            const postsWithUserData = data.results.map({
                "PublicStore.useEffect.postsWithUserData": (post)=>({
                        id: post.id,
                        offer_type: post.offer_type,
                        title: post.title,
                        description: post.description,
                        city: post.city,
                        price: post.price,
                        status: post.status === "accepted" || post.status === "pending" || post.status === "declined" ? post.status : "declined",
                        ...
                        subcategory: post.subcategory ?? "",
                        fav: post.fav === "added" || post.fav === "removed" ? post.fav : "removed",
            ...
            }["PublicStore.useEffect.postsWithUserData"]);
            if (page === 1) {
                ...
                setAllPosts({
                    "PublicStore.useEffect": (prev)=>{
                        ...
                        const newPosts = postsWithUserData.filter({
                            "PublicStore.useEffect.newPosts": (p)=>!existingIds.has(p.id)
                        }["PublicStore.useEffect.newPosts"]);
                        return [
                            ...prev,
                            ...newPosts
            ...
            setHasMore(data.count > allPosts.length + data.results.length);
            setIsLoading(false);
    ...
    const rating = userData?.average_rating || 0;
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "rounded-full overflow-hidden border-2 border-cgreen w-36 h-36 shrink-0",
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$image$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                    src: userData?.profile_image || __TURBOPACK__imported__module__$5b$project$5d2f$public$2f$resourses$2f$userAvatar$2e$svg$2e$mjs__$7b$__IMAGE__$3d3e$__$225b$project$5d2f$public$2f$resourses$2f$userAvatar$2e$svg__$28$static__in__ecmascript$2922$__$7d$__$5b$app$2d$client$5d$__$28$structured__image__object$2c$__ecmascript$29$__["default"],
                                    alt: "صورة الملف الشخصي",
                                    width: 128,
                                    height: 128,
                                    className: "object-cover w-full h-full"
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "text-2xl font-bold text-gray-700 mb-4",
                                        children: userData ? `${userData.first_name} ${userData.last_name}` : "---"
                                    }, void 0, false, {
                                        fileName: "[project]/app/(public)/publicstore/[username]/page.tsx",
                                        lineNumber: 125,
                                        columnNumber: 13
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        className: "font-bold",
                                        children: userData?.total_views || 0
                                    }, void 0, false, {
                                        fileName: "[project]/app/(public)/publicstore/[username]/page.tsx",
                                        lineNumber: 148,
                                        columnNumber: 13
...
_s(PublicStore, "K9wDHFalUibEGXyk+F+gZKgS1fY=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useParams"],
...
//# sourceMappingURL=_0dec3d1e._.js.map