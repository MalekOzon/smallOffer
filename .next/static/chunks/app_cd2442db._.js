...
const editCarForm = async (formData, id)=>{
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$loginservices$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].patch("accounts/posts/cars/" + id + "/", formData, {
        headers: {
            "Content-Type": "multipart/form-data"
        }
    });
...
_s(EditCar, "5TxQFJFqIvfEanp6H635MaHtPq8=", false, function() {
    return [
...
//# sourceMappingURL=app_cd2442db._.js.map