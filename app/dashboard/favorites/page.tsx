...
import { useGetUserFav } from "@/app/lib/dashboardServices/dashboardQueries";
    ...
    <div className="w-full  ">
      ...
      {totalPages == 0 && (
        <div className="flex flex-col items-center justify-center py-16 bg-white rounded-lg shadow-sm border border-gray-100 my-8">
          <h2 className="text-xl font-bold text-cgreen mb-2">
            ليس لديك إعلانات مفضلة حتى الآن
          </h2>
          <p className="text-gray-500 ">
            يمكنك حفظ منشور من خلال الضغط على زر القلب في منشور ما
          </p>
        </div>
      )}
      {totalPages > 0 && (
        <div className="h-full px-4 py-4 bg-gray-50 rounded-md">
