                ...
                {FURNITURE_CHOICES.map(([value, label]) => (
                  ...
                  >
                    <input
                      ...
                      checked={
                        Array.isArray(formData.house?.furniture) &&
                        formData.house.furniture.includes(value)
                      }
                      onChange={handleHouseInputChange}
                    />
                    {label}
                ...
                {GENERAL_CHARACTERISTICS.map(([value, label]) => (
                  ...
                  >
                    <input
                      ...
                      checked={
                        Array.isArray(formData.house?.general_characteristics) &&
                        formData.house.general_characteristics.includes(value)
                      }
                      onChange={handleHouseInputChange}
                    />
                    {label}
