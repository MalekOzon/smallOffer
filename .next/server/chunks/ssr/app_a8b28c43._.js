...
const EditGeneric = ()=>{
    ...
    const id = params.id;
    const editGenericForm = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$postServices$2f$editPostMutation$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEditGenericForm"])(id);
    const { data, isLoading: isFetchingData } = editGenericForm;
    console.log("da   ", data);
...
//# sourceMappingURL=app_a8b28c43._.js.map